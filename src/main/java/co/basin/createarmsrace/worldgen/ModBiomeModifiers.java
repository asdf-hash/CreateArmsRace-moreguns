...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_BAUXTIE_ORE = registerKey("add_bauxite_ore");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_BAUXTIE_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(CreateArmsRace.MODID, name));
    }
}
